...
- [x] **Step 1: Add failing Rust parser tests**
...
- [x] **Step 3: Implement minimal parser/domain changes**
...
- [x] **Step 1: Add failing propagation test**
...
- [x] **Step 2: Implement propagation**
...
- [x] **Step 3: Verify cache compatibility**
...
- [x] **Step 1: Replace the current-day test with a rolling-window test**
...
- [x] **Step 3: Implement rolling retention**
...
- [x] **Step 4: Run history and cache tests**
...
- [x] **Step 2: Implement desktop rendering**
...
- [x] **Step 3: Implement island/ball rendering**
...
- [x] **Step 4: Implement web rendering and horizontal trend**
...
- [x] **Step 2: Inspect the diff for forbidden changes**
...
- [x] **Step 3: Verify snapshot compatibility**
